...
function datenumfrac(days, h, mi, s, ms)
    ms = 60*60*1000 * h +  60*1000 * mi + 1000s + ms
...
abstract type AbstractCFDateTime <: Dates.TimeType end
...
target calendar.
"""
function reinterpret(::Type{T1}, dt::T2) where {T1 <: Union{AbstractCFDateTime, DateTime}, 
                                                T2 <: Union{AbstractCFDateTime, DateTime}}
   return T1(
...
"""
function convert(::Type{T1}, dt::T2) where {T1 <: Union{DateTimeStandard, DateTimeProlepticGregorian, DateTimeJulian},
                                            T2 <: Union{DateTimeStandard, DateTimeProlepticGregorian, DateTimeJulian}}
...
"""
function timeencode(data::AbstractArray{DT,N}, units, calendar = "standard"
                   ) where {N, DT <: Union{DateTime,AbstractCFDateTime,Union{DateTime,Missing}}}
...
function timeencode(data::DT, units, calendar = "standard"
